...
export default function SiteEffects() {
  ...
  useEffect(() => {
    // ── Users accordion ──
    const items = Array.from(document.querySelectorAll<HTMLElement>('.f-user-item'))
    ...
    items.forEach((item) => {
      if (!item.querySelector('.f-user-progress')) {
        const bar = document.createElement('div')
        bar.className = 'f-user-progress'
    ...
    const activate = (item: HTMLElement) => {
      ...
      items.forEach((i) => {
        ...
        const bar = i.querySelector<HTMLElement>('.f-user-progress')
      ...
      const bar = item.querySelector<HTMLElement>('.f-user-progress')
      if (bar) {
